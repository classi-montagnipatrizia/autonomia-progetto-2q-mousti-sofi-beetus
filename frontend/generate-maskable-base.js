...
if (match) {
  ...
  // For maskable icon, we want a solid black background without rounded corners,
  // and the logo should have sufficient padding. The viewport is 1024x1024.
  // The OS will mask it (e.g. into a circle). 
...
${innerPaths}
  ...
  fs.writeFileSync('public/icons/maskable_base.svg', maskableSvg);
  console.log('Created maskable_base.svg');
} else {
